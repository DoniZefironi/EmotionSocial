...
import { createNativeStackNavigator } from '@react-navigation/native-stack'; // стек для каждого таба + модальные окна
import { createBottomTabNavigator } from '@react-navigation/bottom-tabs'; // 3 вкладки
